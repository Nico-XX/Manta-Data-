...
x_train, x_test, y_train, y_test = train_test_split(data[["nboat", "plankton5",]], data[["Mantas"]], test_size=0.2, shuffle=True, random_state=1)
...
pois_reg = smf.poisson("Mantas ~ plankton5 + nboat", data=train2).fit()
